...
const FeatureSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="section-background py-20 relative bg-cover bg-center"
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-[10]">
        <div className="text-center mb-16">
          <h2 className="section-title text-4xl font-serif font-bold mb-4 text-[#D4AF37] px-6 py-3 rounded-lg inline-block shadow-xl bg-black/60 backdrop-blur-sm border border-[#D4AF37]/30">
            למה לבחור באור מיה?
          </h2>
          <p className="max-w-2xl mx-auto text-lg text-white px-4 py-2 rounded-lg shadow-xl bg-black/60 backdrop-blur-sm border border-[#D4AF37]/30">
            אנו מציעים את האיכות הגבוהה ביותר במחירים הוגנים, עם שירות אישי
            וחוויית קנייה מושלמת
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="card-title text-2xl font-serif mb-4 text-gold-gradient px-4 py-2 rounded-lg shadow-sm border border-[#D4AF37]/10">
                  {feature.title}
                </h3>
                <p className="card-text text-[#333] leading-relaxed px-3 py-2 rounded-lg shadow-sm">
                  {feature.description}
                </p>
              </div>
            </div>
